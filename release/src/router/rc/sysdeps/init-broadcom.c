...
void init_others(void)
{
	...
	if (model == MODEL_RTAC56U || model == MODEL_RTAC56S || model == MODEL_RTAC3200 || model == MODEL_RTAC68U || model == MODEL_RPAC68U || model == MODEL_RTAC87U || model == MODEL_RTAC88U || model == MODEL_RTAC3100 || model == MODEL_RTAC5300 || model == MODEL_RTN18U || model == MODEL_EA6900 || model == MODEL_EA9200 || model == MODEL_R7000 || model == MODEL_R8000 || model == MODEL_WS880) {
#ifdef SMP
		int fd;
...
*/
		...
		if (nvram_match(strcat_r(prefix, "nband", tmp), "1") && !nvram_match("ATEMODE", "1")) {
			if (	((get_model() == MODEL_RTAC68U || get_model() == MODEL_RPAC68U || get_model() == MODEL_DSLAC68U || get_model() == MODEL_EA6900 || get_model() == MODEL_R7000 || get_model() == MODEL_WS880) &&
