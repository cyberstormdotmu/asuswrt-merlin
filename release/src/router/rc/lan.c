...
void wlconf_pre()
{
	...
	foreach (word, nvram_safe_get("wl_ifnames"), next) {
		...
		{
			if (model == MODEL_RTN18U || model == MODEL_RTAC3200 || model == MODEL_RTAC68U || model == MODEL_RPAC68U || model == MODEL_DSLAC68U || model == MODEL_RTAC88U || model == MODEL_RTAC3100 || model == MODEL_RTAC5300 || model == MODEL_RTAC87U || model == MODEL_EA6900 || model == MODEL_EA9200 || model == MODEL_R7000 || model == MODEL_R8000 || model == MODEL_WS880) {
